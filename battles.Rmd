...
for (i in 1:length(battle_record$commanders)){
  ratio[i] = ((battle_record$attack_win[i] + battle_record$defend_win[i])/
    (battle_record$attack_win[i] + battle_record$defend_win[i] + battle_record$attack_loss[i]+battle_record$defend_loss[i]))*100
}
