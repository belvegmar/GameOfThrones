...
for (i in 1:length(battle$attacker_commander))
  a[i] = strsplit(battle$attacker_commander[i], ",")[[1]]
...
Como se dijo antes, parece ser que los dos commanders que tienen más prestigio y que han ganado más batallas están a las órdenes de los dos reinos que más se enfrentan entre ellos.